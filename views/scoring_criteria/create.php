...
?>
<div class="card">
    <h2>Add New Scoring Criteria</h2>
    ...
    <form method="POST" action="index.php?controller=scoring_criteria&action=store">
        ...
        <div class="form-group">
            ...
            <input type="text" 
                   id="criteria_name" 
                   name="criteria_name" 
                   value="<?= htmlspecialchars($data['criteria_name'] ?? '') ?>" 
        ...
        <div class="form-actions">
            <button type="submit" class="btn">Save Criteria</button>
