...
<div class="container mt-4">
    ...
    <form method="POST" action="index.php?controller=eligibility_rules&action=store" id="ruleForm">
        ...
        <div class="form-group">
            ...
            <textarea class="form-control" id="rules_json" name="rules_json" rows="8" required placeholder='{"english_level": "IELTS 6.5", "gpa_min": 3.2}'><?= htmlspecialchars($_POST['rules_json'] ?? '') ?></textarea>
