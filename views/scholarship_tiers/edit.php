<?php 
/**
 * @var array $tier Current tier data being edited
...
<div class="card">
    ...
    <form method="POST" action="index.php?controller=scholarship_tiers&action=update">
        <input type="hidden" name="id" value="<?= htmlspecialchars($tier['id']) ?>">
            ...
            <select id="program_id" name="program_id" required>
                ...
                <?php foreach ($programs as $program): ?>
                    <option value="<?= htmlspecialchars($program['id']) ?>" 
                            <?= ($tier['program_id'] ?? 0) == $program['id'] ? 'selected' : '' ?>>
        ...
        <div class="form-group">
            ...
            <input type="number" 
                   ...
                   value="<?= htmlspecialchars($tier['reward_amount'] ?? '') ?>" 
                   required>
        ...
        <div class="form-group">
            ...
            <input type="number" 
                   ...
                   min="1"
                   placeholder="e.g., 10"
                   value="<?= htmlspecialchars($tier['quota'] ?? '') ?>" 
                   required>
...
<script>
/**
 * Client-side form validation for scholarship tier editing
 */
