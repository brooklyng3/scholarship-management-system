        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <h3>Tạo Chứng chỉ Học bổng Mới</h3>
                </div>
                <div class="card-body">
                    <form method="POST" action="<?= e(url('award_certificate', 'store')) ?>" novalidate>
                        <?= csrf_field() ?>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" 
                                   ...
                                   readonly
                                   placeholder="Chọn quyết định để xem số tiền">
                            <small class="form-text text-muted">
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="bi bi-save"></i> Tạo Chứng chỉ
                            </button>
                        </div>
                    </form>
                </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Display awarded amount when decision is selected
