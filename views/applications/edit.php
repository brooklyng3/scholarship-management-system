<?php
/**
 * @var array $application Current application data
...
<div class="card" style="max-width: 600px;">
    <h2>✏️ Edit Application #<?= htmlspecialchars($application['id']) ?></h2>
    ...
    <form method="POST" action="index.php?controller=applications&action=update" id="applicationForm">
